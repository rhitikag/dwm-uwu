...
#include "/home/kuroneko/.cache/wal/colors-wal-dwm.h"
...
static const Key keys[] = {
    ...
    {MODKEY, XK_d, spawn, {.v = (const char *[]){"dmenu-run", NULL}}},
    {MODKEY | ShiftMask,
     XK_d,
     spawn,
     {.v = (const char *[]){"set_wallpaper", NULL}}},
    {MODKEY | ShiftMask,
     XK_p,
     spawn,
     {.v = (const char *[]){"system_menu", NULL}}},
    {MODKEY | ShiftMask,
     XK_d,
     spawn,
    ...
    {MODKEY | ShiftMask,
     XK_b,
     spawn,
     {.v = (const char *[]){"dmenu-browse", NULL}}},
    ...
    {0, XK_Print, spawn, SHCMD(" maim -s | swappy -f -")},
